...
#### RNA
boxplots_ppRNA_aggreg = ggplot(results_li, aes(x = preprocessing_mixRNA, y = score_aggreg, fill = preprocessing_mixRNA)) +
...
#### MET  
boxplots_deMET_aggreg = ggplot(results_li, aes(x = deconvolution_met, y = score_aggreg, fill = deconvolution_met)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
  ...
  labs(
    ...
    x = "Methods",
    y = "Aggregated score",
    fill = "Deconvolution MET"
  )
plotly::layout(
  plotly::ggplotly(boxplots_deMET_aggreg), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
#### MET  deconvolution_met
boxplots_deRNA_aggreg = ggplot(results_li, aes(x = deconvolution_rna, y = score_aggreg, fill = deconvolution_rna)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
  ...
  labs(
    ...
    x = "Methods",
    y = "Aggregated score",
    fill = "Deconvolution RNA"
  )
plotly::layout(
  plotly::ggplotly(boxplots_deRNA_aggreg), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
```{r combinaisons_MAE_scores_DE, echo=FALSE, eval=TRUE}

#### MET  
boxplots_deMET_mae = ggplot(results_li, aes(x = deconvolution_met, y = mae, fill = deconvolution_met)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deMET_mae), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
#### MET  deconvolution_met
boxplots_deRNA_mae = ggplot(results_li, aes(x = deconvolution_rna, y = mae, fill = deconvolution_rna)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deRNA_mae), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
```{r combinaisons_RMSE_scores_DE, echo=FALSE, eval=TRUE}

#### MET  
boxplots_deMET_rmse = ggplot(results_li, aes(x = deconvolution_met, y = rmse, fill = deconvolution_met)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deMET_rmse), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
#### MET  deconvolution_met
boxplots_deRNA_rmse = ggplot(results_li, aes(x = deconvolution_rna, y = rmse, fill = deconvolution_rna)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deRNA_rmse), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
```{r combinaisons_spearman_row_scores_DE, echo=FALSE, eval=TRUE}

#### MET  
boxplots_deMET_spearman_row = ggplot(results_li, aes(x = deconvolution_met, y = spearman_row, fill = deconvolution_met)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deMET_spearman_row), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
#### MET  deconvolution_met
boxplots_deRNA_spearman_row = ggplot(results_li, aes(x = deconvolution_rna, y = spearman_row, fill = deconvolution_rna)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deRNA_spearman_row), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
```{r combinaisons_aitchison_scores_DE, echo=FALSE, eval=TRUE}

#### MET  
boxplots_deMET_aitchison = ggplot(results_li, aes(x = deconvolution_met, y = aitchison, fill = deconvolution_met)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deMET_aitchison), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
...
#### MET  deconvolution_met
boxplots_deRNA_aitchison = ggplot(results_li, aes(x = deconvolution_rna, y = aitchison, fill = deconvolution_rna)) +
  geom_boxplot() +
  facet_wrap(~ dataset, scales = "free_x") +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1, size = 8),
...
plotly::layout(
  plotly::ggplotly(boxplots_deRNA_aitchison), 
  # boxmode = "group",
  legend = list(
    # x = 0,
    # y = -0.3,
